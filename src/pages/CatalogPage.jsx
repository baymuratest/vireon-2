...
import {
  ...
  CATEGORIES, SORT_OPTIONS, STATUS_OPTIONS, ANIME_GENRES
} from '../utils/kodik';
...
export default function CatalogPage() {
  ...
  useEffect(() => {
    ...
    load();
  }, [cat, sort, status, genre, year, types]);
      ...
      <div className="page-inner" style={{ paddingTop: 32, paddingBottom: 80 }}>
        ...
        {filtersOpen && (
          <div className={s.filters}>
            ...
            {/* Reset */}
            {(cat !== 'all' || sort !== 'updated_at' || status || genre || year) && (
  ...
  return (
    <button
      ...
      style={{
        ...
        background: active ? 'rgba(109,40,217,.2)' : 'var(--bg3)',
